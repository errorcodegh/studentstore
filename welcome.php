<?php
   ...
   $ffname = $llname = $emm = $ppss = $tell = "";
   $ffnamerr =  $llnamerr =  $emmrr =  $ppssrr =  $tellrr ="";
...
<body>
	  <div id="registpage">
	  	<form name="delete" action="register.php" method="post">
      ...
      <span class="error">*<?php echo $emmrr; ?></span>
		...
		<input type="text" name="ppss" class="rg" placeholder="ENTER PASSWORD" value="<?php echo $ppss; ?>">
      ...
      <span class="error">*<?php echo $tellrr; ?></span>
        ...
        <p>PLEASE SELECT YOUR<span style="color:blue"> AREA OF SPECIALIZATION</span></p>
            <input type="radio" name="coarse" class="try" id="net">NETWORKING<BR>
            <input type="radio" name="coarse" class="try" id="program">COMPUTER PROGRAMING<BR>   
            <input type="radio" name="coarse" class="try" id="hard">HARDWARE ENGINEER<BR>
            <input type="radio" name="coarse" class="try" id="cyber">CYBER SECURITY<BR>
            <input type="radio" name="coarse"  class="try"id="hack">HACKER<BR>
            <input type="radio" name="coarse"  class="try" id="data">DATABASE ADMINISTRATOR<BR><BR>
   ...
   <p>INDIVIDUAL SKILLED<span style="color:blue">ATTAIANED</span></p>
            <input type="checkbox" name="coarse"  id="net">NETWORKING<br>
            <input type="checkbox" name="coarse" id="hard">HARDWARE ENGINEER<BR>
            <input type="checkbox" name="coarse" id="cyber">CYBER SECURITY<BR>
            <input type="checkbox" name="coarse" id="hack">HACKER<BR>
            <input type="checkbox" name="coarse" id="data">DATABASE ADMINISTRATOR<br>
            <input type="checkbox" name="coarse" id="program">COMPUTER PROGRAMING<BR>  
           <input type="submit" class="sub2" name="submit" value="SUBMIT" onclick="welcomepage()"> 
